...
public class CommonSteps {
    ...
    public void iSeeFurniturePage(String pageName) { // String pageName - параметр
        if (pageName.contains("Ihre Kundendaten")) {
            kundenDatenPage.getHeader().shouldHave(text(pageName)); // shouldHave - говорит, что у локатора должен быть соответствующий текст
